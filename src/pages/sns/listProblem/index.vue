    ...
    <div class="tab-list">
          <ul>
            ...
            <li>
             ...
             <li>
              <a   class="link-on" @click="goStep3">问题大厅</a>
            </li>
             <li>
...
import {listProblem} from '../../../api/api';
...
export default {
  ...
  methods: {
    view(problemId){
      wx.navigateTo({
        url: '/pages/sns/viewProblem/main?problemId='+problemId
      })
    },
    goStep1(){
      wx.redirectTo({
  ...
  onReachBottom() {
    if(this.total>this.list.length){
      ...
      listProblem({'pageNum':this.pageNum}).then((res)=>{
